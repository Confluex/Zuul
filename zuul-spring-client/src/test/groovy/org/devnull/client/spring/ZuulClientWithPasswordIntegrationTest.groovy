...
@ContextConfiguration(locations = ['classpath:test-zuul-with-password-context.xml'])
class ZuulClientWithPasswordIntegrationTest extends BaseHttpServerIntegrationTest {
