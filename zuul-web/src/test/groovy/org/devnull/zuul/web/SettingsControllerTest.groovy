...
public class SettingsControllerTest {
    ...
    void renderPropertiesByNameAndEnvRenderPropertiesFile() {
        ...
        def group = new SettingsGroup(name:"my-application", environment: "dev")
        ...
        when(controller.zuulService.findSettingsGroupByNameAndEnvironment(group.name, group.environment)).thenReturn(group)
        controller.renderPropertiesByNameAndEnv(mockResponse, group.name, group.environment)
        verify(controller.zuulService).findSettingsGroupByNameAndEnvironment(group.name, group.environment)
